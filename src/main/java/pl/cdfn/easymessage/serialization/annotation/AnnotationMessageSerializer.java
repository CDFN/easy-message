package pl.cdfn.easymessage.serialization.annotation;
...
import pl.cdfn.easymessage.util.sneaky.SneakyBiConsumer;
import pl.cdfn.easymessage.util.sneaky.SneakyFunction;
